...
<div class="container-scroller">
    ...
    <div class="row" id="alert_add">
        <div class="col-md-5 grid-margin stretch-card" style="margin: 0 auto">
            <div class="card">
                <div class="card-body" id="add_around_view">
    ...
    function viewListLoad(data) {
        for(let i=0;i<data.length;i++){
            let con =$(` <tr>
                              ...
                              <td>
                                   <a href="around_view_details.jsp?viewId=${'${data[i].viewId}'}""><button type="button" class="btn btn-inverse-info btn-fw">景点</button></a>
        ...
        let con = $(`
              <form class="forms-sample" action="http://localhost:8080/arViewAdd" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="arViewDistance" class="form-control" id="InputDis" placeholder="distance" value="">
                        </div>
                        <div class="form-group">
